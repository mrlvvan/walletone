...
function App() {
  ...
  const trendingItems = [
    { id: 'adi', name: 'ADI', change: '11,55%', price: '195,57 ₽', icon: '△', styleClass: 'adi' },
    { id: 'cat', name: 'CATI', change: '11,97%', price: '3,64 ₽', icon: '🐾', styleClass: 'cati' },
    { id: 'link', name: 'LINK', change: '10,84%', price: '730,62 ₽', icon: '⬡', styleClass: 'link' },
    { id: 'apt', name: 'APT', change: '15,07%', price: '93,65 ₽', icon: '⎔', styleClass: 'apt' },
  ];
